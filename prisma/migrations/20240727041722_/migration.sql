...
INSERT INTO "new_Notification" ("forUserId", "fromUserId", "id", "message", "resourceId", "typeId") SELECT "forUserId", "fromUserId", "id", "message", "resourceId", "typeId" FROM "Notification";
